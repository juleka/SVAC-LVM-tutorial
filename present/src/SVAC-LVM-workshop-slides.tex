...
\begin{itemize}
\item True SVAC prevalence as a \emph{latent trait} that can't be observed directly but estimated
\item Available human rights reports  as imperfect SVAC measures due to observational challenges
\item Human-coded SVAC variables as imperfect measures of human rights reports due to coding error
\item Information convergence/divergence across sources as a measure of certainty regarding SVAC prevalence
\end{itemize}

The logic of latent variable models (LVM) builds on precisely this conceptual approach to measurement. 
}
