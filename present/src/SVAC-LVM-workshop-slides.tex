...
\caption{Estimated level of engagement in wartime sexual violence by state forces in Sudan \hyperlink{SUDAN-obs}{\beamerbutton{obs}}}
\end{figure}
\end{frame}


\begin{frame}[label=DRC-static]
\frametitle{Our Second Worst Case... }
\begin{figure}\centering
\includegraphics[width=11cm]{../visualize/output/pp-static-estimates-DR-Congo-Zaire-283.pdf}
\caption{Estimated level of engagement in wartime sexual violence by state forces in DRC \hyperlink{DRC-obs}{\beamerbutton{obs}}}
\end{figure}
\end{frame}
