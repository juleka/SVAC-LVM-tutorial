...
\item Latent variable model (LVM) logic and parameters 
\item Estimating LVM and visualizing different outcomes
...
\begin{itemize}
\item[(1)] local indepedence of different indicators within the same conflict-year,
